...
permissions:
  ...
  contents: read
steps:
  - run: uv tool install git+https://github.com/libre-devops/python-helpers@v0.3.0
...
```bash
uv tool install "libre-devops-helpers[keychain] @ git+https://github.com/libre-devops/python-helpers@v0.3.0"
```
